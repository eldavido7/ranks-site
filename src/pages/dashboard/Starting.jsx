            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <motion.div
                        ...
                        className="bg-white p-8 rounded-3xl shadow-lg max-w-2xl w-full relative">
                        {/* Close Button */}
                        <button
                            onClick={toggleModal}
                        ...
                        {/* Modal Title */}
                        <h2 className="text-2xl font-bold text-center mb-6">Task Submission</h2>
                        ...
                        <div className="flex items-center space-x-6 mb-4">
                            ...
                            <div className="text-right flex-grow">
                                <p className="text-lg font-semibold">Product 647</p>
                                <p className="text-lg font-semibold">Product 897</p>
                                <p className="text-lg font-semibold">Product 807</p>
                                <p className="text-lg text-red-500 font-bold mt-2">USD 4350</p>
                                <p className="text-gray-500 text-sm mt-1">Score Ranking</p>
                                <div className="flex justify-end mt-1 text-gray-400 text-xl">
                        ...
                        <div className="flex justify-between border-t border-b py-4 mb-4 text-center">
                            <div>
                                <p className="text-lg font-semibold text-gray-500">Total amount</p>
                                <p className="text-red-500 font-bold text-lg">USD 4350</p>
                            </div>
                            <div>
                                <p className="text-lg font-semibold text-gray-500">Commission</p>
                                <p className="text-red-500 font-bold text-lg">USD 652.5</p>
                            </div>
                        </div>
